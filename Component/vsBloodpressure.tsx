...
export default function vsBloodpressure (){
   ...
   <div className="hidden">
    ...
    <div className="flex flex-col w-[25rem] pl-[2rem] pt-[1rem]">
      ...
      <label className="text-[1.51rem]  font-Sans-serif">Please follow the instructions to take your Blood Pressure reading.</label>
      <p className="text-[1.51rem]  font-Sans-serif" >Step 1: Pick up the Blood Pressure Cuff located on the right side of the kiosk</p>
      <p className="text-[1.51rem]  font-Sans-serif">Step 2: Wrap the cuff around your upper arm</p>
      <p className="text-[1.51rem]  font-Sans-serif">Step 3: Set down and Relax</p>
      <p className="text-[1.51rem]  font-Sans-serif">Step 4: Press the trigger button to take your reading.</p>
      <p className="text-[1.51rem]  font-Sans-serif">Step 5: Input the readings in the box for the Systolic (mmHg) and Diastolic(mmHg) blood pressure on the right side and click Proceed. </p>
      </div>
      ...
      <div className= " border-gray p-[1rem] w-[27rem] bg-stone-100 gap-[1.5rem] flex flex-col">
        ...
        <label className="text-[1.51rem]  font-Sans-serif">Systolic (mmHg):</label>
        ...
        <section className="flex flex-col">
        <label className="text-[1.51rem]  font-Sans-serif">Diastolic (mmHg):</label>
        <input type="Text" className=" text-[1.51rem] font-Sans-serif border border-stone-300 bg-stone-200 rounded-sm px-[0.5rem] py-[0.25rem]" placeholder=" Input Here"/>
        </section>
