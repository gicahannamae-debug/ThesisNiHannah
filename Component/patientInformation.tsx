...
export default function patientInformation (){
    ...
    <div className="flex flex-col w-[25rem] pl-[2rem] pt-[1rem]">
      ...
      {/* Patient Information Wrapper */}
        ...
        <h1 className="text-[3rem] font-bold font-Sans-serif text-green-900">Patient Information</h1>
        <p className="text-[1.7rem] font-serif">Please enter your details to begin.</p>
        </div>
        ...
        <input type="Text" className="text-[1.7rem] font-Sans-serif border border-stone-300 bg-stone-200 rounded-sm px-[0.5rem] py-[0.25rem]" placeholder="e.g Hanna Mae"/>
        </section>

        <section className="flex flex-col">
        <label className="text-[1.51rem] font-Sans-serif">Last Name</label>
        <input type="Text" className=" text-[1.7rem] font-Sans-serif border border-stone-300 bg-stone-200 rounded-sm px-[0.5rem] py-[0.25rem]" placeholder="e.g Gica"/>
        </section>

        <section className="flex flex-col">
        <label className="text-[1.51rem]">Age</label>
        <input type="Text" className="text-[1.7rem] font-Sans-serif border border-stone-300 bg-stone-200 rounded-sm px-[0.5rem] py-[0.25rem]" placeholder="e.g 22"/>
        </section>
